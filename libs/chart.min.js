...
!(function (t, e) {
    ...
    for (let t = c, i = c; t <= d; ++t)
      (m = e[t % a]),
        m.skip ||
          ((p = h(m[s])),
          p !== x &&
            ((b = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p)));
  ...
  class An {
    ...
    constructor(t, e) {
      ...
      (this.id = i()),
        ...
        (Pn[this.id] = this),
        r && l
          ? (bt.listen(this, "complete", wn), bt.listen(this, "progress", kn), this._initialize(), this.attached && this.update())
    ...
    getDatasetMeta(t) {
      ...
      return (
        s ||
          ((s = { type: null, data: [], dataset: null, controller: null, hidden: null, xAxisID: null, yAxisID: null, order: (e && e.order) || 0, index: t, _dataset: e, _parsed: [], _sorted: !1 }),
          i.push(s)),
        s
      );
    }
  ...
  function Bn(t, e, i, s) {
    ...
    "middle" === n && i && ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Wn(c, a, r, l)] = !0), (n = h))),
      (o[Wn(n, a, r, l)] = !0),
      (t.borderSkipped = o);
  }
  function Wn(t, e, i, s) {
  ...
  var fo = Object.freeze({
    ...
    BarElement: class extends Hs {
      ...
      draw(t) {
        ...
        var r;
        t.save(),
          (o.w === n.w && o.h === n.h) || (t.beginPath(), a(t, uo(o, e, n)), t.clip(), a(t, uo(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
          t.beginPath(),
          a(t, uo(n, e)),
          (t.fillStyle = s),
          t.fill(),
  ...
  class ba extends Hs {
    ...
    _draw() {
      ...
      (f = x ? { x: ft(n, this.left + c, this.right - i[0]), y: this.top + c + b, line: 0 } : { x: this.left + c, y: ft(n, this.top + b + c, this.bottom - e[0].height), line: 0 }),
